...
CREATE TABLE `admin` (
  ...
  `name` varchar(100) DEFAULT NULL COMMENT '管理员名',
  `pass` varchar(50) DEFAULT NULL COMMENT '管理员密码',
  `type` int NOT NULL DEFAULT '0' COMMENT '权限类型',
...
INSERT INTO `admin` VALUES (1,'admin','admin',1,'2020-04-21 10:19:07','2020-04-21 10:19:07');
...
CREATE TABLE `customer` (
  ...
  `coupon` int DEFAULT NULL COMMENT '优惠券id',
  `type` int NOT NULL DEFAULT '0' COMMENT '入住状态',
  `checkin` timestamp NOT NULL COMMENT '入住时间',
  `checkout` timestamp NOT NULL COMMENT '退房时间',
  PRIMARY KEY (`id`)
...
CREATE TABLE `jobs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT NULL COMMENT '职位名',
  PRIMARY KEY (`id`)
...
CREATE TABLE `log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(300) DEFAULT NULL COMMENT '记录内容',
...
-- Dump completed on 2020-04-21 18:25:46
