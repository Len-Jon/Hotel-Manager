    ...
    <form method="post" action="/saveEmployee">
        ...
        <div style="margin-bottom: 10px;">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active"><a href="/addEmployee">新增员工</a></li>
            </ul>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">员工名</label>
            <input type="text" class="form-control" placeholder="请输员工姓名" name="name">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="请输员工身份证" name="idCard">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="请输员工工号" name="jobNumber">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="请输员工家庭住址" name="address">
        </div>
